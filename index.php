...
<ul id="menu">
    ...
    <li data-menuanchor="socials"><a href="#socials">My Socials</a></li>
</ul>
    ...
    <div class="section" id="section1">
            ...
            <div class="intro">
                ...
                <div class="card">
                    ...
                    <div class="container">
                        ...
                        <p>Member of the Scouts since 2007</p>
                        <p>Awarded DofE Bronze Award</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="slide">
            <div class="intro">
                ...
                <div class="bar-container">
                    <div class="bar">
                        <div class="jetbrains inner-bar"><span class="skills-title">JetBrains IDE's</span><span class="skills-percent">90%</span></div>
                    </div>
                    <div class="bar">
                        <div class="git inner-bar"><span class="skills-title">git</span><span class="skills-percent">80%</span></div>
                    </div>
                    <div class="bar">
                        <div class="mysql inner-bar"><span class="skills-title">MySQL/phpMyAdmin</span><span class="skills-percent">70%</span></div>
                    </div>
                    <div class="bar">
                        <div class="jira inner-bar"><span class="skills-title">JIRA Software</span><span class="skills-percent">70%</span></div>
                    </div>
                    <div class="bar">
                        <div class="ci inner-bar"><span class="skills-title">Jenkins & CI/CD</span><span class="skills-percent">60%</span></div>
                    </div>
                    <div class="bar">
                        <div class="maven inner-bar"><span class="skills-title">Maven Build Management</span><span class="skills-percent">60%</span></div>
                    </div>
                    <div class="bar">
                        <div class="ubuntu inner-bar"><span class="skills-title">Linux CLI (Ubuntu) </span><span class="skills-percent">60%</span></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="slide">
            <div class="intro">
                ...
                <div class="bar-container">
                    <div class="bar">
                        <div class="pij inner-bar"><span class="skills-title">Programming in Java</span><span class="skills-percent">100%</span></div>
                    </div>
                    <div class="bar">
                        <div class="dsa inner-bar"><span class="skills-title">Data Structures & Algorithms</span><span class="skills-percent">96%</span></div>
                    </div>
                    <div class="bar">
                        <div class="fp inner-bar"><span class="skills-title">Functional Programming</span><span class="skills-percent">88%</span></div>
                    </div>
                    <div class="bar">
                        <div class="ccpp inner-bar"><span class="skills-title">Systems Programming in C/C++</span><span class="skills-percent">87%</span></div>
                    </div>
                    <div class="bar">
                        <div class="tp inner-bar"><span class="skills-title">Team Project</span><span class="skills-percent">81%</span></div>
                    </div>
                    <div class="bar">
                        <div class="lc inner-bar"><span class="skills-title">Logic & Computation</span><span class="skills-percent">79%</span></div>
                    </div>
                    <div class="bar">
    ...
    <div class="section" id="section2">
                    ...
                    <div class="project-box">
                        <div class="project-text-right">
                            ...
                            <div class="links">
                                ...
                                <a href="https://twitch.tv/auroramcnetwork"><i class="fab fa-twitch fa-4x"></i></a>
                                <a href="https://github.com/AuroraMC"><i class="fab fa-github fa-4x"></i></a>
                                <a href="mailto:block@auroramc.net"><i class="fas fa-envelope fa-4x"></i></a>
                                <a href="https://discord.auroramc.net/"><i class="fab fa-discord fa-4x"></i></a>
                                <a href="https://www.youtube.com/channel/UC2PknNrONPqHh31XlrXkIOg"><i class="fab fa-youtube fa-4x"></i></a>
                        </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="slide">
            <div class="intro">
                <div class="project-container">
                    <div class="project-img">
                        <img class="img-fluid" src="img/profile.png" width="60%" alt="AuroraMC Logo">
                    </div>
                    <div class="project-box">
                        <div class="project-text-right">
                            ...
                            <a href="https://github.com/Block2Block?tab=repositories&q=ir"><button type="button" class="btn btn-secondary waves-effect waves-light">Intelligent Robotics »</button></a>
                            <a href="https://github.com/Block2Block/Functional-Programming-Assignments"><button type="button" class="btn btn-secondary waves-effect waves-light">Functional Programming »</button></a>
                            <a href="https://github.com/Block2Block/Systems-Programming-Assignments"><button type="button" class="btn btn-secondary waves-effect waves-light">Systems Programming »</button></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="project-container">
                    ...
                    <div class="project-box">
                        <div class="project-text-right">
                            ...
                            <a href="https://github.com/Block2Block/CheeseBot"><button type="button" class="btn btn-archive waves-effect waves-light">CheeseBot »</button></a>
                            <a href="https://github.com/Block2Block/SquadGoalsSMP"><button type="button" class="btn btn-archive waves-effect waves-light">Squad Goals SMP »</button></a>
                            <a href="https://github.com/Block2Block/CheeseUHC"><button type="button" class="btn btn-archive waves-effect waves-light">Cheese UHC »</button></a>
                            <a href="https://github.com/Block2Block/Battleship-Singleplayer"><button type="button" class="btn btn-archive waves-effect waves-light">BattleShips Singleplayer Prototype »</button></a>
                            <a href="https://github.com/Block2Block/BattleshipSingleplayer"><button type="button" class="btn btn-archive waves-effect waves-light">BattleShips Singleplayer Final »</button></a>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    var myFullpage = new fullpage('#fullpage', {
        ...
        anchors: ['home', 'about', 'work', 'socials'],
        menu: '#menu',
